      ...
      <div class="video-item" v-for="(item, index) in list" :key="index">
        <div class="v-i-box">
          <video
            ...
            controls
          ></video>
          <img v-else src="http://192.168.31.114:9999/image/tooopen_sy_143912755726.jpg" alt="" class="video-bg">
        ...
        <div class="v-i-info">
          ...
          <div class="action">
            <div class="a-box">
              <div class="a-b-item">
                <img src="./../../assets/images/video/vant-ico-0.png" alt="">
